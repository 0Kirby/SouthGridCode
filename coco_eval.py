...
ap.add_argument('-p', '--project', type=str, default='insulator', help='project file that contains parameters')
ap.add_argument('-c', '--compound_coef', type=int, default=2, help='coefficients of efficientdet有效支付系数')
ap.add_argument('-w', '--weights', type=str, default='./logs/insulator/efficientdet-d2_47_27269.pth', help='/path/to/weights')
